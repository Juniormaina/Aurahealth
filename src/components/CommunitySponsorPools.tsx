...
export const CommunitySponsorPools: React.FC<CommunitySponsorPoolsProps> = ({
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="aura-card-gradient p-4 sm:p-6 relative z-20 isolate overflow-hidden">
        <div className="relative z-10 flex flex-wrap items-center justify-between gap-4 mb-4">
          <div className="flex items-center gap-3 min-w-0">
            ...
            <div className="min-w-0 relative z-10">
              <h2 className="relative z-10 text-lg sm:text-2xl font-black text-white leading-tight">
          ...
          <button
            ...
            className="btn-primary text-xs px-4 py-2.5 rounded-xl shadow-lg transition-all flex items-center gap-2 w-full sm:w-auto justify-center"
          >
      ...
      {isDepositOpen && (
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-slate-950/80 backdrop-blur-md">
          <div className="bg-slate-900 border border-slate-800 w-full max-w-md rounded-2xl p-6 shadow-2xl relative modal-sheet">
